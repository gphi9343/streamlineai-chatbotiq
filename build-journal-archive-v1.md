# ChatbotIQ Build Journal — Archive v1
Sessions 1–5 (incl. Session 3 postscript and Session 5 V1.3.1 / V1.3.2
patches). Archived 10 June 2026, Session 34. Active journal continues at
Session 22 in build-journal.md.

Note: version numbers do not track session numbers linearly in this era —
Session 4 builds V1.4 before Session 5 builds V1.3, and V1.4.x work
continues in the active file (Session 23+). The cut is by session number,
which is contiguous. Do not infer a clean version range from this archive.
