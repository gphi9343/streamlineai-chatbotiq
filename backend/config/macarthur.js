...
export const macarthurConfig = {
  ...
  voice_profile: {
    ...
    example_messages: [
      ...
      "Pricing depends a fair bit on the material and the job, so I can't give you a figure here. If you'd rather not fill in the whole form right now, just leave your email here instead and the team can follow up directly — or if you'd prefer, the quote request page has everything the team needs to get you proper pricing and colour options.",
